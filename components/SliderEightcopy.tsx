...
export default function SliderEightcopy() {
  ...
  return (
    <div className="relative h-screen bg-[#e5d7b4]">
      ...
      {/* Slider Container */}
     <div className="w-full flex flex-col justify-center pl-4 pt-12 md:pl-16 md:pt-0">
...
{/* Navigation Dots - Positioned at bottom right */}
    ...
    {/* </div> */}
      ...
      {/* texts */}
      <div className=" px-4 flex  flex-col items-center justify-start md:items-center md:justify-center bg-[#e5d7b4]">
              <h1 className="text-lg lg:text-2xl md:mb-0  mt-0">
               Our Philosophy
              </h1>
