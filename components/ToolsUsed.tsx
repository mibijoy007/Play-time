...
const ToolsUsed: React.FC = () => {
  return (
     ...
     <div className="py-14">
        <h2 className="text-center pb-3 text-3xl md:text-4xl font-semibold text-gray-900">
            Tools We Use
          </h2>
          <p className="text-center mb-8 text-gray-600 max-w-2xl mx-auto px-4">
            Hosting is on your preferences or we will decide whick one to use if you don&apos;t have preferences
          </p>


      
    <section className="py-0 pt-4 sm:pt-2 bg-white">
      <div className=" md:max-w-5xl mx-auto px-4 text-center">
        {/* <h2 className="text-3xl font-bold mb-6">Tools & Technologies I Use</h2> */}
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-12 md:gap-16 items-center justify-items-center">
